...
#    Updated: 2020/05/08 11:52:55 by jiandre          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC		=	 ft_atoi.c   ft_calloc.c   ft_isalpha.c  ft_isdigit.c ft_itoa.c  ft_memccpy.c  ft_memcmp.c ft_lstadd_back.c ft_lstiter.c\
